...
PAIRS = [
    ...
    # 山地鄉鄉長：只有 1998／2002 需要換算。2005 的 D1 實測與同屆區域檔
    # 319 個代碼逐一相符，不需對照——同屆的 T2／T3 卻需要，兩者不可互相推論。
    ("1998", "D1-MT", "1998鄉鎮市長", "1998縣市議員/區域"),
    ("2002", "D1-MT", "2002鄉鎮市長選舉", "2002縣市議員/區域"),
]
...
# 2026-08-27 加入 1998／2002 的 D1-MT 後由 1290／829 更新為下列值。
# 增量：兩屆各 319 列（共 638），其中代碼不同者 1998 為 230、2002 為 123。
EXPECTED_TOTAL = 1928
EXPECTED_DIFFERENT = 1182
